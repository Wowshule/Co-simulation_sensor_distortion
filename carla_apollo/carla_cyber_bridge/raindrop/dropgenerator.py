...
def generateDrops(image_array, cfg, inputLabel = None):
	"""
	...
	# PIL_bg_img = Image.open(image_array)
	# bg_img = np.asarray(PIL_bg_img)

	PIL_bg_img = Image.fromarray(image_array)
	bg_img = np.asarray(PIL_bg_img)
	...
	#############################
	# fixed_positions = [(254, 370), (384, 13), (194, 85), (235, 205), (497, 369), (125, 456), (493, 98), (407, 207), (53, 228), (489, 246), (542, 247), (525, 170), (505, 456), (169, 168), (213, 393), (4, 215), (148, 400), (184, 207), (629, 226), (136, 185), (616, 312), (586, 240), (109, 371), (253, 343), (132, 414), (445, 451), (321, 40), (293, 43), (91, 12), (330, 215), (240, 430), (245, 115), (384, 144), (541, 13), (569, 468), (223, 268), (226, 135), (601, 188), (211, 278), (510, 67), (338, 329), (505, 120), (298, 308), (506, 187), (362, 421), (23, 369), (65, 370), (361, 415), (163, 95), (255, 357), (273, 95), (22, 140), (591, 453), (150, 197), (47, 417), (239, 277), (370, 63), (576, 298), (392, 255), (434, 304), (8, 469), (39, 221), (177, 119), (485, 113), (479, 123), (564, 131), (489, 46), (564, 45), (618, 143), (266, 294), (308, 384), (604, 140), (368, 4), (280, 345), (232, 136), (286, 414), (620, 303), (99, 294), (86, 93), (557, 210), (97, 246), (153, 390), (336, 123), (152, 342), (238, 224), (259, 476), (129, 209), (530, 20), (143, 182), (59, 354), (69, 142), (331, 346), (305, 181), (548, 81), (141, 176), (269, 312), (232, 199), (114, 161), (311, 24), (636, 314)]
	# ran_pos = fixed_positions[:drop_num]
	######################
	...
	if ifReturnLabel:
		...
		return np.asarray(PIL_bg_img), output_label
		# return PIL_bg_img, output_label

	return np.asarray(PIL_bg_img)
	# return PIL_bg_img




def generateDrops_Mosaic(image_array, cfg, inputLabel = None):
	"""
	This function generate the drop with random position
	"""
	...
	if inputLabel is None:
		for key, pos in enumerate(ran_pos):
			...
			key = key+1
			radius = random.randint(minR, maxR)
			drop = raindrop(key, pos, radius, type='Mosaic')
			listRainDrops.append(drop)
	#using input label			
	else:
		arrayLabel = np.asarray(inputLabel)
	...
	for drop in listFinalDrops:
		...
		tmp_bg = bg_img[ROIU:ROID, ROIL:ROIR,:]
		drop.updateTexture_GaussianFilter(tmp_bg)
		tmp_alpha_map  = alpha_map[ROIU:ROID, ROIL:ROIR]
